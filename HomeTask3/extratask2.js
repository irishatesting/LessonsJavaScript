/* Task 1
    ...
    min(1, 1) == 1
*/
function findMinimunOfNumbers (a,b) {
    if (a < b) {
        return a;
    }
    else return b;
}
console.log(findMinimunOfNumbers(-100, 45));
...
*/
const createMessage = (a) => {
    switch (a) {
        case 0: console.log("My lunch for today is ramen");
            break;
        case 1: console.log("My lunch for today is pizza");
            break;
        case 2: console.log("My lunch for today is spagetti");
            break;
        default: console.log("You don't have lunch for today")
    }  
};
...
var finalResult = function1(function2);
...
*/
function task13Func(amount) {
    let string = "g";
    for (let i = 1; i <= amount; i++) {
        string = string + "o";
    }
    console.log(string + "gle");
}
task13Func(17);